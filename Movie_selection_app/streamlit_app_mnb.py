...
#load dataset
reviews = pd.read_csv(r'Movie_images\movie_dataset_nb.csv')
...
if option is 'Evaluation':
    st.image("heatmap_mnb.png", width=800, caption="Heat Map")
    st.image("wordcloud_positive_mnb.png", width=800, caption="Word Cloud")
