...
if __name__ == "__main__":
    ...
    sentimet = pd.read_csv(r'training.csv', sep=",")
    ...
    #lemitize = lem
    stemitize = stemming(stop_word)

    #print(stemitize)
    classifier = NaiveBayesClassifier.train(stemitize)
    print("Accuracy is:", classify.accuracy(classifier, stemitize.items()))
